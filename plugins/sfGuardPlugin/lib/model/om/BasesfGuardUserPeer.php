  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in BlogArticlePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related BlogArticle objects
			$c = new Criteria(BlogArticlePeer::DATABASE_NAME);
			
			$c->add(BlogArticlePeer::USER_ID, $obj->getId());
			$affectedRows += BlogArticlePeer::doDelete($c, $con);
